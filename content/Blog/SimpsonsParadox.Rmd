---
title: 'Why Do Expensive Products Get Worse Ratings?'
date: '2020-09-17'
author: Nick Arnosti
tags:
  Simpson's Paradox
...
```{r,echo=FALSE}
#Consider the following hypothetical scenario. Suppose that a set of runners are allowed into a shoe store, asked to test and rate all of the shoes, and then rewarded with a free pair of shoes of their choosing. What predictions could we make? The first hypothesis predicts that some people will choose a cheap pair of shoes. The second hypothesis allows for the possibility that everyone will choose expensive shoes, but predicts that some people will rate the cheap shoes more highly. The third hypothesis reveals that it's possible that **every** runner would rate expensive shoes more highly.


# implies that many people would choose a cheap pair of shoes as their reward. The second (that ratings reflect value) allows the possibility that everyone would choose an expensive pair to take home, but many would nevertheless rate some cheaper pair more highly. The third could occur even if **every** runner would rate the more expensive shoe more highly.**

#The bigger problem is that often, we don't see both stories. It's easy to conduct aggregate analysis, but much harder to identify relevant subgroups. In some cases (such as Berkeley's university admissions), the subgroups (departments) are easy to identify. In others, they are not. In the kidney stone example, one might not think to group by stone size. In our shoe example, it's not easy to classify people as "casual" and "serious" runners and display separate ratings for each.
#I'm sure that there is some truth to all three explanations discussed in this post.  The value hypothesis, which says that many people rate the premium shoes lower because of their price, is likely a contributor. But I think it's also important to keep the selection effect in mind.
```
