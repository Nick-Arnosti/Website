---
title: 'Centralized Registration for COVID Vaccines'
date: "2021-02-24"
author: Nick Arnosti
tags:
  Queueing Theory
...
There are articles from all over the country [complaining about decentralized registration](https://www.wusa9.com/article/news/health/coronavirus/vaccine/montgomery-county-maryland-vaccine-registration-steps/65-77c857b2-add2-4eaf-a9c8-16da6b829b85), giving [advice for scoring an appointment](https://www.bostonmagazine.com/news/2021/02/23/massachusetts-vaccine-online-tips/), and lauding volunteers who [help others book appointments](https://www.texasmonthly.com/news/scheduling-angels-are-scouring-the-internet-to-book-vaccine-appointments-for-strangers/). 
...
It seems natural to use a centralized system to schedule all appointments: allow people to register for a state-wide waiting list, and notify them when it is their turn.^[In January, delays in vaccination arose because many healthcare providers were eligible but not eager to receive the vaccine. One advantage of using a centralized registration system is that eligibility is granted only to people who have expressed interest in being vaccinated, making take-up easier to predict.] Several states have started to do this, including my home state of [Minnesota](https://www.startribune.com/how-to-make-an-appointment-to-get-the-covid-19-vaccine-in-minnesota/600012422/?refresh=true). However, often these registration systems only apply to [vaccination centers run by the state](https://www.baltimoresun.com/coronavirus/bs-hs-maryland-creates-limited-vaccine-wait-list-20210224-55b2jf7sgjbeviornv2vdvwfc4-story.html). 
...
<!--Ideally, eligibility could be widened gradually, so that appointments are not so difficult to find.^[In practice, this ideal confronts several challenges. To ensure that the vaccine is administered as quickly as possible, it helps to have a large pool of eligible applicants, as many states learned in January after trying to use narrow eligibility criteria. At that time, many healthcare workers were eligible but not eager to receive the vaccine, forcing states to widen eligibility. One advantage of a centralized registration system is that it only grants eligibility to those who express interest, making "yield" more predictable. In theory, this should allow states to keep the pool of eligible people only slightly higher than the number of available appointments, but only if appointments can be scheduled in advance. This is made difficult by the fact that the supply of vaccine available to each state varies from week to week.]-->
